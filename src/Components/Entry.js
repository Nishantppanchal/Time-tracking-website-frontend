    ...
    return(
        <Box className='containerBox'>
            ...
            <Grid container direction='row' spacing={8} width='40%'>
                ...
                {/* Login button */}
                    <Button variant='contained' fullWidth onClick={handleLoginButton} className='roundButton' >Login</Button>
                </Grid>
            <Grid item xs={6}> {/* Let button fill half the grid */}
                {/* Sign up button */}
                    <Button variant='contained' fullWidth onClick={handleSignUpButton} className='roundButton'>SIGN UP</Button>
                </Grid>
            </Grid>
